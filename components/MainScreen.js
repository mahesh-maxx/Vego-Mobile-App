            ...
            <ScrollView contentContainerStyle={StyleSheet.contentContainer}>
                ...
                <View style={{ marginTop: 5,marginLeft:5, flex: 1, flexDirection: 'row', flexWrap: 'wrap' }}>
                    ...
                    <TouchableOpacity  onPress={()=>this.props.navigation.navigate('Category', {
                        ...
                        <Text style={{fontFamily: 'serif', fontSize: 20, textAlign: 'center' }}>Juices</Text>
                    </TouchableOpacity>
                    <TouchableOpacity  onPress={()=>this.props.navigation.navigate('Category', {
                        category: "Salad"
                        ...
                        <Text onPress={()=>this.props.navigation.navigate('Category')} style={{ fontFamily: 'serif', fontSize: 20, textAlign: 'center' }}>Salads</Text>
                    </TouchableOpacity>
                    <TouchableOpacity  onPress={()=>this.props.navigation.navigate('Category', {
